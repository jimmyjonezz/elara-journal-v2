...
function extractSimpleDynamicTags(text) {
  // Расширенный и уточненный список стоп-слов
  const stopWords = new Set([
    ...
    // Добавленные местоимения и служебные слова
    ...
    "все", "всё", "всех", "всем", "всеми", "вся", "всю", "всею", "сам", "сама", "само", "сами",
    "очень", "более", "менее", "очень", "слишком", "довольно", "достаточно"
]);
  ...
  const minFrequency = 3; // Новое значение
