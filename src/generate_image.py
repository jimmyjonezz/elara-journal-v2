...
try:
    ...
    url = f"https://image.pollinations.ai/prompt/{encoded}?width=1024&height=1024&model=playground-v2.5&nologo=true&seed={entry_date.strftime('%Y%m%d')}&negative=bad+anatomy+mutation+extra+fingers+deformed"
