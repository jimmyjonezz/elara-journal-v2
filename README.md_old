...
- Формат: 70–90 слов, без клише.

### 🎭 2. Анализ критиком
- Критик — **не внешний судья**, а **внутренний голос, имитирующий диалог с прошлым собой**.
- Говорит: *«Я не ожидала, что ты придёшь сюда.»* вместо *«В тексте наблюдается...»*
- Советы — как **тихие вопросы себе**.
...
- Трекинг тегов, кластеров, уровней рефлексии.
- При ошибках — сырые ответы сохраняются в `logs/raw_llm_responses.log`.
